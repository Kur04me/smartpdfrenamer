...
- 取引先名...後述の取引先名リストから優先して選択。合致するものがなければ内容を考慮して新たに生成。
 ...
 */
export async function extractPdfInfo(pdfPath: string, options: CommandLineOption) {
  // pdf -> base64
  ...
  // console.log(responseOutputText);
